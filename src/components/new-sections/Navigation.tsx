                                ...
                                <NavigationMenuItem>
                                    ...
                                    <NavigationMenuContent>
                                        <div className="grid gap-3 p-6 w-[400px]">
                                            <Link to="/services/uiux-design" className="flex items-center gap-3 hover:bg-gray-100 p-3 rounded-lg transition-colors">
                                            ...
                                            <Link to="/services/development" className="flex items-center gap-3 hover:bg-gray-100 p-3 rounded-lg transition-colors">
